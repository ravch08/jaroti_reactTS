...
const Login = () => {
	...
	return (
		<Link to="#!" className="login">
			<svg width="16" height="16" viewBox="0 0 17 17" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			...
			<div className="login-dropdown">
				<form onSubmit={handleSubmit(onForm2Submit)} noValidate>
					<div className="form-control">
						...
						<input
							...
							{...register("loginemail", {
								...
								validate: {
									notBlacklisted: function (fieldValue) {
										return !fieldValue.endsWith("yahoo.com") || "This domain is not supported!";
									},
								},
							})}
						/>
